...
<div id="howToUpload">
	...
	<div class="row">
		<div class="col-md-6"><a href="javascript:void(0)" faction="url" class="btn btn-lg btn-primary showForm btn-block">Upload dari URL / Youtube</a></p></div>
		<div class="col-md-6"><a href="javascript:void(0)" faction="image" class="btn btn-lg btn-primary showForm btn-block">Upload File Image</a></div>
	</div>
</div>
  ...
  $.ajax({
      ...
      success: function(data) 
      {
          if (data.success == 'true') {
          	//redirect
          	$("#uploadProgress").html("Upload Success ... redirect");
